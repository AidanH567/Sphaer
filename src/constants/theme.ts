...
export const colors = {
  ...
  neutral: {
    ...
    neutral500:'#949494',   // neutral/neutral-500 — timestamps / stat labels
...
// ─── Poster palettes ─────────────────────────────────────────────────────────
// Colour pairs for the auto-generated event poster (src/utils/poster-template.ts).
// Deliberately OUTSIDE the app-chrome palette above: the Mural is a street
// poster wall, and a wall of Neutral/* greys is not one. These echo the hand-
// authored seed posters in scripts/generate-svg-posters.ts — Berlin risograph /
// Das Plakat territory — so a generated poster sits next to a designed one
